		...
		<div class="container">
			<div class="row">
				<div class="page-header-title">
					<h2>
                        <em>Соприкосновение с природой есть самое последнее слово всякого прогресса, науки, рассудка, здравого смысла, вкуса и отличной манеры.</em>:Ф.М. Достоевский
				    </h2>		
				</div>
			</div>	
		</div>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class('blog-detail-section'); ?>>
				...
				<div class="blog-post-title">
					<div class="blog-post-date">
					    <!--span class="date">
					        <a href="<?php the_permalink();?>"><?php echo get_the_date('j'); ?> 
